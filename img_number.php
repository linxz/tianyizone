...
<div class="img_box" style="width:<?php echo $box_w_result;?>px;padding:<?php echo $box_padding;?>px;<?php if($box_border == 0){echo 'border:0 none;';}else{echo 'border:'.$box_border.'px solid #FF0000;';}?>">
	<ul style="margin-left:-<?php echo $img_margin;?>px">
		...
		<li style="margin-left:<?php echo $img_margin;?>px"><img src="http://placebox.es/<?php echo $img_width;?>" alt="" /></li>
		<?php }?>
	</ul>
</div>
<div class="code_box">
...
<div class="img_box" style="width:<?php echo $box_w_result;?>px;padding:<?php echo $box_padding;?>px;<?php if($box_border == 0){echo 'border:0 none;';}else{echo 'border:'.$box_border.'px solid #FF0000;';}?>">
	<ul>
	<?php for($i=1;$i<=$img_num;$i++) {?>
	<li><img src="http://placebox.es/<?php echo $img_width;?>" alt="" /></li>
	<?php }?>
</ul>
</div></textarea>
</div>

<div style="float:right;margin-top:15px;font-size:12px;"><script language="javascript" type="text/javascript" src="http://js.users.51.la/385492.js"></script>
<noscript><a href="http://www.51.la/?385492" target="_blank"><img alt="&#x6211;&#x8981;&#x5566;&#x514D;&#x8D39;&#x7EDF;&#x8BA1;" src="http://img.users.51.la/385492.asp" style="border:none" /></a></noscript></div>
</body>
</html>
